...
func TestWebhooks(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			filename:    "./testdata/repo-refs-changed.json",
			headers: http.Header{
				"X-Event-Key":     []string{"repo:refs_changed"},
		...
		},
		{
			...
			filename:    "./testdata/repo-modified.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/repo-forked.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/repo-comment-edited.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/repo-comment-deleted.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/repo-comment-added.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-reviewer-unapproved.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-reviewer-updated.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-opened.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-modified.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-merged.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-reviewer-needs-work.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-deleted.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-declined.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-comment-edited.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-comment-deleted.json",
			headers: http.Header{
		...
		},
		{
			...
			filename:    "./testdata/pr-reviewer-approved.json",
			headers: http.Header{
